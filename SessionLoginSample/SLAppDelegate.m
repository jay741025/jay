...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
       // self.viewController = [[SLViewController alloc] initWithNibName:@"SLViewController_iPhone" bundle:nil];
        storyboard = [UIStoryboard storyboardWithName:@"SLViewController_iPhone" bundle:nil];
    } else {
        //self.viewController = [[SLViewController alloc] initWithNibName:@"SLViewController_iPad" bundle:nil];
        storyboard = [UIStoryboard storyboardWithName:@"SLViewController_iPad" bundle:nil];
    }
    
    // Instantiate the initial view controller object from the storyboard
    self.viewController = [storyboard instantiateViewControllerWithIdentifier:@"SLViewController"];
